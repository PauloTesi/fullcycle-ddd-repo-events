...
import PrintConsole1CustomerCreateddHandler from "../customer/handler/enviar-console-log-1-customer-created";
import PrintConsole2CustomerCreateddHandler from "../customer/handler/enviar-console-log-2-customer-created";
